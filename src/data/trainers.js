...
// ── Route 1 ────────────────────────────────────────────────────────────────
t('r1_ollie', { title: 'Youngster', name: 'Ollie', sprite: 'kid', party: [['nibbit', 4]], intro: "I saw you come out of the lab! Let's see what you've got!", lose: 'Aww, my Nibbit!', after: "Keep your Morphs healthy — your mum's cooking works wonders, trust me." });
t('r1_dana', { title: 'Lass', name: 'Dana', sprite: 'lass', party: [['beakling', 4], ['nibbit', 5]], intro: "Eyes on me! My Morphs are the cutest on the whole route!", lose: "Cute AND beaten. Ugh.", after: 'Beaklings peck Nature Morphs to pieces. Just saying!' });
t('r1_theo', { title: 'Tamer', name: 'Theo', sprite: 'youth', party: [['trotter', 6]], intro: "Trotter and I run this route every morning. Let's race!", lose: "We lost the race.", after: 'Brindlewood is just north. The Trial there is tough — train up first.' });
t('r1_nell', { title: 'Bug Fan', name: 'Nell', sprite: 'kid_b', party: [['chittik', 5], ['chittik', 5]], intro: "Shh! You'll scare the Chittiks! ...Too late. BATTLE!", lose: 'My Chittiks!', after: 'Chittiks turn into Mantipules. They get these little boxing gloves. Well, claws.' });
...
// ── Brindlewood Trial ─────────────────────────────────────────────────────
t('bw_adept_1', { title: 'Moss Adept', name: 'Fern', sprite: 'lass', party: [['burrlet', 9], ['chittik', 9]], intro: 'Warden Mossa taught me: a garden is patient. I am... trying to be patient. BATTLE!', lose: 'Patience... failing...', after: 'Mossa is right at the end of the hall. Good luck!' });
t('bw_adept_2', { title: 'Moss Adept', name: 'Rowe', sprite: 'ranger', party: [['sporra', 10], ['burrlet', 10]], intro: 'Roots run deep in this hall. Let me show you!', lose: 'Uprooted!', after: "Mossa's Thornbur is her pride and joy. Watch out for Seed Volley." });
...
// ── Route 2 ───────────────────────────────────────────────────────────────
t('r2_pim', { title: 'Bug Fan', name: 'Pim', sprite: 'kid_b', party: [['chittik', 10], ['fuzzling', 11]], intro: 'I caught a Fuzzling! It is soft AND it will fight you!', lose: 'Soft AND defeated...', after: 'Fuzzlings turn into Mothlumes. They glow! At night! On your pillow!' });
t('r2_fisher', { title: 'Angler', name: 'Doyle', sprite: 'fisher', party: [['puddlet', 11], ['gullip', 11]], intro: "Nothing's biting. Guess I'll bite YOU. Er. Battle you.", lose: 'Should have stayed fishing.', after: "Can't cross water without a boat. Saltreach sells 'em to Tide Sigil holders." });
t('r2_ivy', { title: 'Lass', name: 'Ivy', sprite: 'lass', party: [['nibbit', 11], ['burrlet', 11], ['beakling', 12]], intro: "You're the one who beat Mossa? Prove it!", lose: 'Okay, okay, I believe you!', after: 'Thornwild is creepy. People in robes have been walking in there all week.' });
t('r2_bram', { title: 'Hiker', name: 'Bram', sprite: 'hiker', party: [['pebbling', 12], ['trotter', 12]], intro: "HOI! Solid as rock, me and my Pebbling! Try us!", lose: 'Crumbled!', after: 'Pebblings evolve into Cragmauls. Big fists. Bigger hugs.' });

// ── Thornwild ────────────────────────────────────────────────────────────
t('tw_bugs', { title: 'Bug Fan', name: 'Rook', sprite: 'kid', party: [['chittik', 12], ['mantipule', 14]], intro: 'Thornwild has the BEST bugs. Want to see my best bug?!', lose: 'My best bug!', after: 'The shrine in the middle of the forest is really old. Older than Brindlewood.' });
t('tw_ranger', { title: 'Ranger', name: 'Sable', sprite: 'ranger', party: [['sporra', 13], ['fuzzling', 13]], intro: 'Rangers keep these woods safe. Show me you can handle yourself.', lose: 'You can handle yourself.', after: 'If you find a lost Burrlet with a bell, it belongs to little Posy in Brindlewood.' });
t('tw_mystic', { title: 'Mystic', name: 'Orla', sprite: 'mystic', party: [['hushling', 14], ['pookit', 13]], intro: 'The trees whispered your name. They were not complimentary.', lose: 'The trees were wrong.', after: "Something under the shrine is humming. It's the same note the Seal-stones hum." });
acolyte('tw_acolyte_1', 'Tove', [['oozelet', 13], ['echirp', 13]], { intro: "This shrine belongs to the Mother! Go home, little Tamer.", lose: 'Ugh! Brother, hold the dig!' });
acolyte('tw_acolyte_2', 'Ansel', [['jellume', 14], ['gullip', 13]], { sprite: 'acolyte_b', intro: 'You defeated Tove?! Then the Mother sends ME.', lose: "We'll... we'll finish the dig another day!" });
...
t('st_adept_2', { title: 'Angler', name: 'Perch', sprite: 'fisher', party: [['puddlet', 16], ['jellume', 17]], intro: "Hooked you!", lose: "...I've been hooked.", after: 'Jellumes can poison you. Bring some Purge Herbs.' });
...
t('r3_fisher', { title: 'Angler', name: 'Skip', sprite: 'fisher', party: [['jellume', 19], ['puddlet', 18], ['gullip', 18]], intro: 'Quiet! The fish can hear you. So can my Morphs.', lose: "Snapped my line.", after: 'The tide pools here are full of Crabbits.' });
t('r3_ace', { title: 'Ace Tamer', name: 'Juno', sprite: 'ace', skill: 2, reward: 40, party: [['voltquill', 19], ['pugnet', 20]], intro: 'An Ace Tamer never backs down. Neither should you.', lose: 'You fight like an Ace already.', after: 'Voltquills evolve at 25. Their feathers crackle like a storm.' });
...
t('cf_engineer', { title: 'Engineer', name: 'Pell', sprite: 'engineer', party: [['coilbit', 21], ['ferrite', 20]], intro: "I'm surveying the old workings. And you're blocking my survey.", lose: 'Survey says: I lost.', after: 'Take that disc over there. The Deepcall left it behind.' });
...
// ── Route 4 ───────────────────────────────────────────────────────────────
t('r4_mystic', { title: 'Mystic', name: 'Wynne', sprite: 'mystic', party: [['omenet', 26], ['hushling', 26]], intro: 'The stones told me you would come this way. They also told me to battle you.', lose: 'The stones did not mention this part.', after: 'The circle of stones hums in the fog. So do the Seals.' });
...
t('r4_hiker', { title: 'Hiker', name: 'Tor', sprite: 'hiker', party: [['cragmaul', 27], ['tunnip', 26], ['pebbling', 26]], intro: "I've climbed every hill on this moor. Twice!", lose: 'Downhill from here.', after: "Frostspire's past Hollowmere and across the lake. You'll need a boat." });
...
t('hm_adept_3', { title: 'Veil Adept', name: 'Gloam', sprite: 'mystic', party: [['duskwing', 29], ['pookit', 29]], intro: "The Warden is listening to us right now. Make it a good story.", lose: 'A good story indeed.', after: 'Morrow will tell you a story whether you win or lose. Win.' });
warden('morrow', { name: 'Morrow', sprite: 'morrow', items: ['full_tonic'], party: [['pookit', 30], ['duskwing', 31], ['cairnite', 31], ['vesperel', 33]], intro: "Every Trial is a story, {PLAYER}. Mine is a ghost story. Let's see how yours ends.", lose: '...And the hero walked out of the fog. A good ending.', win: 'Not every story ends well. Try again.' });
...
// ── Route 5 ───────────────────────────────────────────────────────────────
t('r5_fisher', { title: 'Angler', name: 'Bass', sprite: 'fisher', party: [['jellume', 30], ['gullip', 30], ['crabbit', 30]], intro: 'An island all to myself — until YOU paddled up.', lose: 'Back to my island solitude.', after: 'Glasslake is so clear you can see the old road under the water.' });
...
t('r5_skier', { title: 'Skier', name: 'Freya', sprite: 'skier', party: [['chillcub', 31], ['flurrit', 31]], intro: 'First snow of the season! Let me show you how we battle up north!', lose: 'Wiped out!', after: 'Frostspire is right up the path. Warm your hands at the Haven.' });
...
t('fs_adept_3', { title: 'Rime Adept', name: 'Astrid', sprite: 'skier', party: [['flurrit', 34], ['chillcub', 34]], intro: 'Last stop before the summit!', lose: 'Summit reached. By you.', after: 'The Warden is waiting at the top. Go.' });
...
t('r6_ace', { title: 'Ace Tamer', name: 'Sol', sprite: 'ace', skill: 2, reward: 45, party: [['arcfowl', 37], ['pugilus', 37], ['wyrmkin', 36]], intro: 'Five Sigils? You must be heading for the Wyrm Trial. Prove you deserve it!', lose: 'You deserve it.', after: "Seren's Riftwyrm is the strongest Morph I've ever seen. Frost is its weakness." });
...
t('rg_adept_2', { title: 'Wyrm Adept', name: 'Ember', sprite: 'ace_b', party: [['blazewing', 39], ['wyrmkin', 39]], intro: "Dragons don't flinch. Do you?", lose: 'I flinched.', after: 'Drake moves hit Drake Morphs super hard. Use that.' });
