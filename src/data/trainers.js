...
t('r2_fisher', { title: 'Angler', name: 'Doyle', sprite: 'fisher', party: [['puddlet', 10], ['gullip', 10]], intro: "Nothing's biting. Guess I'll bite YOU. Er. Battle you.", lose: 'Should have stayed fishing.', after: "Can't cross water without a boat. Saltreach sells 'em to Tide Sigil holders." });
...
t('tw_mystic', { title: 'Mystic', name: 'Orla', sprite: 'mystic', party: [['hushling', 13], ['pookit', 12]], intro: 'The trees whispered your name. They were not complimentary.', lose: 'The trees were wrong.', after: "Something under the shrine is humming. It's the same note the Seal-stones hum." });
